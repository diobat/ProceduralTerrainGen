...
std::vector<float> genMountains(unsigned int seed, unsigned int size, float scale) 
{

    // Mountains everywhere
    std::vector<float> perlinMapMountains = generatePerlinMap(seed+1, size, size, 3, 0.4f * scale, 1.2f, 1.0f, 0.8f);
